...
class file_paths:
    ...
    hawaii_template_sql = data_sources / "hawaii_template.sql"
    triggers_sql = data_sources / "triggers.sql"
    hawaii_triggers_sql = data_sources / "hawaii_triggers.sql"
    conus_hydrofabric = hydrofabric_dir / "conus_nextgen.gpkg"
    conus_hydrofabric_graph = hydrofabric_dir / "conus_igraph_network.gpickle"
    hawaii_hydrofabric = hydrofabric_dir / "hi_nextgen.gpkg"
    hawaii_hydrofabric_graph = hydrofabric_dir / "hi_igraph_network.gpickle"
